    ...
    return (
      <div className="container pt-24 sm:pt-40 grid-bg min-h-screen">
        <div className="max-w-2xl border-l-4 border-foreground pl-6">
          <p className="text-[10px] font-black text-muted-foreground tracking-[0.3em] mb-2">Error / System Access Denied</p>
          <h1 className="text-4xl font-black tracking-tighter text-foreground italic mb-6">Access Blocked</h1>
          <p className="text-xs font-bold tracking-widest text-muted-foreground leading-relaxed">
    ...
    return (
      <div className="container flex min-h-screen flex-col items-center justify-start pt-24 sm:pt-40 grid-bg">
        <div className="flex flex-col items-center gap-4">
           ...
           <span className="text-[10px] font-black tracking-[0.4em]">Syncing Registry...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container pt-24 pb-12 sm:pt-40 sm:pb-20 animate-slide-up grid-bg min-h-screen">
      <div className="mb-16 border-l-4 border-foreground pl-6">
        <p className="text-[10px] font-black text-muted-foreground tracking-[0.3em] mb-2">
          Assessment Portal / Student Interface
        </p>
        <h1 className="text-5xl font-black tracking-tighter text-foreground italic">
          Question Papers
        </h1>
        <p className="mt-4 text-[11px] font-bold tracking-widest text-muted-foreground max-w-xl leading-relaxed">
      ...
      {papers.length === 0 ? (
        <div className="border border-dashed border-foreground/20 p-16 text-center">
          <p className="text-[10px] font-black tracking-[0.4em] text-muted-foreground">
          ...
          {papers.map((paper, i) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                 ...
                 {paper.submissionId && (
                   <span className="text-[8px] font-black tracking-widest bg-foreground text-background px-2 py-0.5">Evaluated</span>
                 )}
              </div>
              
              <h3 className="text-lg font-black tracking-tighter italic text-foreground mb-2 line-clamp-1">
                {paper.name}
              </h3>
              {paper.description && (
                <p className="text-[10px] font-bold tracking-widest text-muted-foreground line-clamp-2 leading-relaxed mb-6">
                  {paper.description}
                </p>
              )}
              
              <div className="mt-auto pt-6 border-t border-foreground/5">
                <p className="text-[9px] font-black tracking-widest text-muted-foreground mb-4">
